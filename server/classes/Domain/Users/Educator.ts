...
export default class Educator extends User {
    constructor(name: String, displayName: String, email: String, avatar: String, intro: String, pushNotificationToken: String,
        ...
        role: String, languagesOfExpertise: [ProgrammingLanguage] | any[], password?: String, id?: Number) {
            super(role, displayName, email, avatar, name, education, programmingExperience, null);
            this.name = name;
